...
class ActsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create act" do
    assert_difference('Act.count') do
      post acts_url, params: { act: { link: @act.link, title: @act.title, when: @act.when, who: @act.who } }
    end
  ...
  test "should update act" do
    patch act_url(@act), params: { act: { link: @act.link, title: @act.title, when: @act.when, who: @act.who } }
